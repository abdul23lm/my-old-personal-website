...
const SkillSetModal = ({ isOpen, onClose }: ISkillSetModal) => {
  ...
  const uiToolCols = splitSkills(Skills.uiTools)
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
